...
<body  style="background-color: #000000ab;">
        ...
        <div class="main-content" style="background-color:transparent;padding: 3%;">
            <div >
                <h1 style="font-size:50px;text-align-center;padding:25px;color:#ffa500"><i class="fas fa-users-cog fa-2x" ></i>&nbsp;&nbsp;Manage Admin&nbsp;&nbsp;<i class="fas fa-users-cog fa-2x" ></i></h1> <br>
                        ...
                        if ($count>0){
                            ...
                            while($rows = mysqli_fetch_assoc($result)){
                                ...
                                <tr style="background-color:LightGray;">
                                    ...
                                    <button class="button"><a href="manage-admin/update.php?id=<?php echo $admin_id ?>">Update</a></button>
                                    <button class="button"><a href="manage-admin/delete.php?id=<?php echo $admin_id ?>">Delete</a></button>
                                    <button class="button"><a href="manage-admin/change_pass.php?id=<?php echo $admin_id ?>">Change Password</a></button>
                                    </td>
                                </tr>
                                <?php
                                $sn++;
